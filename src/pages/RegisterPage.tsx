    ...
    <div className="min-h-screen bg-[#000000] flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#555555]">Create your account</p>
        </div>
        ...
        <div className="bg-[#0D0D0D] border border-[#2A2A2A] rounded-2xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0D0D0D] px-3 text-[#555555]">
                or continue with
              </span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-[#555555] mt-6">
          ...
          <Link to="/login" className="text-[#E8003D] hover:underline no-underline font-medium">
            Sign in
          </Link>
        </p>
      </motion.div>
