      ...
      >
        ...
        <div className="bg-[#0D0D0D] border border-[#2A2A2A] rounded-2xl p-8">
          ...
          <div className="mt-4 text-center">
            <Link
              to="/forgot-password"
              className="text-sm text-[#E8003D] hover:underline no-underline font-medium"
            >
              Forgot password?
            </Link>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0D0D0D] px-3 text-[#555555]">or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-[#555555] mt-6">
          ...
          <Link to="/register" className="text-[#E8003D] hover:underline no-underline font-medium">
            Sign up
          </Link>
        </p>
      </motion.div>
